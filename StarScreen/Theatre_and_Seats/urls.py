...
from .views import TheatreAdminView,TheatreListView,TheaterDetailsView,SeatAdminView,SeatDetailsView,SeatListView,ScheduleSetUpAdminView,ScheduleListView
